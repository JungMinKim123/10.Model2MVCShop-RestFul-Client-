...
//		System.out.println("\n====================================\n");
//		// 2.1 Http Post 방식 Request : JsonSimple lib 사용
//		UserRestHttpClientApp.updateUserPostTest_JsonSimple();
		
//		System.out.println("\n====================================\n");
//		// 1.2 Http Post 방식 Request : CodeHaus lib 사용
//		UserRestHttpClientApp.updateUserPostTest_Codehaus();	
		
//		System.out.println("\n====================================\n");
//		// 2.1 Http Post 방식 Request : JsonSimple lib 사용
//		UserRestHttpClientApp.listUserPostTest_JsonSimple();
		
		System.out.println("\n====================================\n");
		// 1.2 Http Post 방식 Request : CodeHaus lib 사용
		UserRestHttpClientApp.listUserPostTest_Codehaus();	
...
//			HttpEntity httpEntity01 = new StringEntity(json.toString(),"utf-8");
		...
		public static void updateUserTest_JsonSimple() throws Exception{
			...
			String url= 	"http://127.0.0.1:8080/user/json/updateUser/user50";
...
//			HttpEntity httpEntity01 = new StringEntity(json.toString(),"utf-8");
	...
	//[ 방법 3 : codehaus 사용]
	Map<String, Search> map1 =  new HashMap<String, Search>();
//	user01.setUserId("user50");
//	user01.setUserName("김정민");
	ObjectMapper objectMapper01 = new ObjectMapper();
	//Object ==> JSON Value 로 변환
	String jsonValue = objectMapper01.writeValueAsString(map1);
