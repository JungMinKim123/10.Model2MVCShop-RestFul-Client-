...
//				HttpEntity httpEntity01 = new StringEntity(data,"utf-8");
			...
			json.put("prodName", "상추");
			json.put("price", "2000");
			json.put("prodDetail", "강원도의 맛");
			
//			Map<String, String>  map = new HashMap<String, String>();
//			map.put("prodName", "상추");
//			map.put("price", "2000");
//			map.put("prodDetail", "강원도의 맛");
...
//			HttpEntity httpEntity01 = new StringEntity(json.toString(),"utf-8");
			...
			prod.setProdName("돈까스");
			prod.setPrice(7000);
			prod.setProdDetail("바사삭 식감이 좋아요");
...
//				HttpEntity httpEntity01 = new StringEntity(data,"utf-8");
			...
			json.put("prodName", "개성손만두");
			json.put("prodDetail", "만두속이 꽉!");
			HttpEntity httpEntity01 = new StringEntity(json.toString(),"utf-8");
...
//			HttpEntity httpEntity01 = new StringEntity(json.toString(),"utf-8");
			...
			user01.setProdName("불닭볶음면");
			user01.setProdDetail("불타도록 매운 맛");
			ObjectMapper objectMapper01 = new ObjectMapper();
			//Object ==> JSON Value 로 변환
